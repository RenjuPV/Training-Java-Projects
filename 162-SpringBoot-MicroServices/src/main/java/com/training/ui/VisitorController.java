...
public class VisitorController {
	...
	public ResponseEntity<Visitor>f1(){
		Visitor visitor=new Visitor(101, "Renju", "Female", "Kottayam");
		return ResponseEntity.ok(visitor);
	}
	
	@GetMapping("/fetchVisitors")
	public ResponseEntity<List<Visitor>>f2(){
		Visitor visitor1=new Visitor(102, "Anju", "Female", "Kottayam");
		Visitor visitor2=new Visitor(103, "Manju", "Female", "Kochi");
