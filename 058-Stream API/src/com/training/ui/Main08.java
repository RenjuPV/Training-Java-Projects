...
public class Main08 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Count of male Employee :"+maleEmpCount);
		
		
		long cochinEmpCount=allEmployees
				.stream()
				.filter(e->e.getCityName().equalsIgnoreCase("COC"))
				.count();
		
		System.out.println("Count of employee from COC : "+cochinEmpCount);
		
		
		long basicSalEmpCount=allEmployees
				.stream()
				.filter(e->e.getBasic()>25000.00)
				.count();
		
		System.out.println("Count of employee whose basic salary greater than 25000 : "+basicSalEmpCount);
